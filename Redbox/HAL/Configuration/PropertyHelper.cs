...
namespace Redbox.HAL.Configuration
{
    public static class PropertyHelper
    {
            ...
            foreach (XmlNode parentNode1 in xmlNodeList1)
            {
                try
                {
                    ...
                    if (element != null)
                    {
                        ...
                        {
                            CustomEditorAttribute customAttribute = (CustomEditorAttribute)System.Attribute.GetCustomAttribute((MemberInfo)element, typeof(CustomEditorAttribute));
        ...
        private static void WalkObjectTree(object instance, XmlWriter xmlWriter)
        {
            ...
            {
                BrowsableAttribute customAttribute1 = (BrowsableAttribute)System.Attribute.GetCustomAttribute((MemberInfo)property, typeof(BrowsableAttribute));
                if (customAttribute1 == null || customAttribute1.Browsable)
                {
                    xmlWriter.WriteStartElement("property");
                    xmlWriter.WriteAttributeString("name", property.Name);
                    DisplayNameAttribute customAttribute2 = (DisplayNameAttribute)System.Attribute.GetCustomAttribute((MemberInfo)property, typeof(DisplayNameAttribute));
                    if (customAttribute2 != null)
                        xmlWriter.WriteAttributeString("display-name", customAttribute2.DisplayName);
                    DescriptionAttribute customAttribute3 = (DescriptionAttribute)System.Attribute.GetCustomAttribute((MemberInfo)property, typeof(DescriptionAttribute));
                    if (customAttribute3 != null)
                        xmlWriter.WriteAttributeString("description", customAttribute3.Description);
                    CategoryAttribute customAttribute4 = (CategoryAttribute)System.Attribute.GetCustomAttribute((MemberInfo)property, typeof(CategoryAttribute));
                    if (customAttribute4 != null)
                        xmlWriter.WriteAttributeString("category", customAttribute4.Category);
                    ReadOnlyAttribute customAttribute5 = (ReadOnlyAttribute)System.Attribute.GetCustomAttribute((MemberInfo)property, typeof(ReadOnlyAttribute));
                    if (customAttribute5 != null)
                        xmlWriter.WriteAttributeString("read-only", XmlConvert.ToString(customAttribute5.IsReadOnly));
                    CustomEditorAttribute customAttribute6 = (CustomEditorAttribute)System.Attribute.GetCustomAttribute((MemberInfo)property, typeof(CustomEditorAttribute));
                ...
                (object) xmlWriter
                    ...
                    else
                    {
                        ...
                        if (!System.Attribute.IsDefined((MemberInfo)property, typeof(ExcludeTypeAttribute)))
                            xmlWriter.WriteAttributeString("type", property.PropertyType.AssemblyQualifiedName);
                        if (System.Attribute.IsDefined((MemberInfo)property, typeof(RecurseAttribute)) && obj != null)
                        {
                            PropertyHelper.WalkObjectTree(obj, xmlWriter);
                        }
                        else
                        {
                            ValidValueListProviderAttribute customAttribute7 = (ValidValueListProviderAttribute)System.Attribute.GetCustomAttribute((MemberInfo)property, typeof(ValidValueListProviderAttribute));
